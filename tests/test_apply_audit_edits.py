...
class TestCollectRunsInfoAcrossParagraphs:
    ...
    def test_single_paragraph_returns_correct_flag(self):
        ...
        runs_info, combined_text, is_cross_paragraph = applier._collect_runs_info_across_paragraphs(start_para, 'AAA')
    ...
    def test_multiple_paragraphs_returns_correct_flag(self):
        ...
        runs_info, combined_text, is_cross_paragraph = applier._collect_runs_info_across_paragraphs(start_para, 'CCC')
    ...
    def test_paragraph_boundaries_as_newlines(self):
        ...
        runs_info, combined_text, is_cross_paragraph = applier._collect_runs_info_across_paragraphs(start_para, 'BBB')
...
class TestApplyManualCrossParagraph:
    ...
    def test_manual_comment_across_paragraphs(self):
        ...
        runs_info, combined_text, is_cross_paragraph = applier._collect_runs_info_across_paragraphs(para_aaa, 'CCC')
